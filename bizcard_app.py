...
def home_page():
    ...
    st.write("""
        <div class="home-text">
            <br>
            <p style='font-size: 40px;font-weight: bold;color: purple'>BizCard App</p>
            <p style='font-size: 20px;'>Welcome to BizCard Data Extraction Application. Our application makes it easy to scan and preserves vital details from business cards, helping you stay organized and connected.</p>
            <p style='font-size: 20px; line-height: 1.5;'>Say goodbye to manual data entry and hello to effortless networking.</p>
            </br>       
        </div>
